...
class AppDesignSystem extends ThemeExtension<AppDesignSystem> {
  ...
  @override
  ThemeExtension<AppDesignSystem> lerp(ThemeExtension<AppDesignSystem>? other, double t) {
    ...
    return AppDesignSystem(
      ...
      liquidGradient: LinearGradient.lerp(liquidGradient, other.liquidGradient, t) ?? liquidGradient,
  ...
  factory AppDesignSystem.fromConfig(ThemeConfig config) {
    ...
    final accent = config.style == ThemeStyle.neo ? primary.withOpacity(0.8) : const Color(0xFFFF2D55);
  ...
  // Role Defaults
  static AppDesignSystem student() => AppDesignSystem.fromConfig(ThemeConfig.studentDefault());
  static AppDesignSystem parent() => AppDesignSystem.fromConfig(ThemeConfig.parentDefault());
  static AppDesignSystem teacher() => AppDesignSystem.fromConfig(ThemeConfig.teacherDefault());
}

extension AppDesignSystemExt on ThemeData {
  AppDesignSystem get design => extension<AppDesignSystem>() ?? AppDesignSystem.student();
}
